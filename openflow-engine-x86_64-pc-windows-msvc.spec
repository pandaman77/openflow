...
datas += tmp_ret[0]; binaries += tmp_ret[1]; hiddenimports += tmp_ret[2]
# llama_cpp loads its native llama.dll from llama_cpp/lib via ctypes —
...
a = Analysis(
    ['core\\openflow-engine\\engine_entry.py'],
    pathex=['core/openflow-engine'],
    binaries=binaries,
    datas=datas,
...
exe = EXE(
    ...
    a.datas,
    [],
    name='openflow-engine-x86_64-pc-windows-msvc',
    debug=False,
